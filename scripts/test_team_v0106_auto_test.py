#!/usr/bin/env python
"""Framepack v0.10.6 test-team automatic acceptance script.
...
FRAMEPACK_VERSION = "0.10.6"
REPORT_JSON = "framepack-v0106-auto-test-report.json"
...
def _render_markdown(payload: dict[str, Any]) -> str:
    lines = [
        "# Framepack v0.10.6 Auto Test Report",
        "",
        f"- Repo: `{payload['repo']}`",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--output-dir", default="test-team-reports/v0.10.6", help="Directory for JSON/Markdown reports")
