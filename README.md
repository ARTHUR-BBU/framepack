...
> Framepack v0.18.0 turns fuzzy video intent into a director-approved HyperFrames workflow: route the job, ask for assets, write the creative bible, hand off cleanly, then taste-audit before render.
