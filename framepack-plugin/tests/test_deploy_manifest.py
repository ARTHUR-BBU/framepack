...
def test_0120_release_version_is_synchronized_across_release_surfaces():
    ...
    release_files = {
        REPO_ROOT / "README.md": ["version **0.18.0**", "Framepack v0.18.0"],
        REPO_ROOT / "docs" / "README.zh-CN.md": ["版本为 **0.18.0**"],
        REPO_ROOT / "AGENTS.md": ["version: 0.18.0", "v0.18.0 hooks", "Framepack v0.18.0 skills"],
        PLUGIN_ROOT / "plugin.yaml": ["version: \"0.18.0\"", "Framepack v0.18.0 is the HyperFrames 0.7.21 Director Workbench"],
        PLUGIN_ROOT / "skills" / "framepack" / "SKILL.md": ["# Framepack v0.18.0 — HyperFrames 0.7.21 Director Workbench", "Environment & Upgrade Manager"],
        PLUGIN_ROOT / "__init__.py": ["Framepack v0.18.0 Plugin registering"],
        PLUGIN_ROOT / "hooks" / "on_pre_tool_call.py": ["v0.18.0 philosophy", "Framepack v0.18.0 pre_tool_call hook registered"],
        PLUGIN_ROOT / "hooks" / "on_post_tool_call.py": ["Framepack v0.18.0", "Framepack v0.18.0 post_tool_call hook registered"],
        ...
        PLUGIN_ROOT / "core" / "arsenal_registry.py": ['DEFAULT_PLUGIN_VERSION = "0.18.0"'],
        PLUGIN_ROOT / "core" / "timeline_manifest.py": ['DEFAULT_PLUGIN_VERSION = "0.18.0"'],
        PLUGIN_ROOT / "scripts" / "apply_skill_overlays.py": ['FRAMEPACK_VERSION = "0.18.0"'],
        PLUGIN_ROOT / "templates" / "timeline-manifest.example.json": [
            '"plugin_version_created": "0.18.0"',
            '"plugin_version_updated": "0.18.0"',
        ],
    }
