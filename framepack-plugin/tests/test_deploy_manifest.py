...
def test_0120_release_version_is_synchronized_across_release_surfaces():
    ...
    release_files = {
        ...
        PLUGIN_ROOT / "plugin.yaml": ["version: \"0.16.0\"", "Framepack v0.16.0 is the HyperFrames 0.7.3 Director Workbench"],
        PLUGIN_ROOT / "skills" / "framepack" / "SKILL.md": ["# Framepack v0.16.0 — HyperFrames 0.7.3 Director Workbench", "Environment & Upgrade Manager"],
