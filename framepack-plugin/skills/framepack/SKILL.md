...
# Framepack v0.18.0 — HyperFrames 0.7.21 Director Workbench
...
Framepack 创意引擎
    ...
    ↓
Weapon Matching Pass（HTML 前备菜台）
    ├── 官方 HyperFrames catalog/references
    ├── Framepack executable arsenal
    ├── specialist skills（gsap / captions / transitions / media / reference-miner）
    └── HANDWRITE waiver 收据
    ↓
HyperFrames 工具链接管
    ├── 读 frame.md（视觉参数）
...
## v0.18.0: Director Workbench for HyperFrames 0.7.21
