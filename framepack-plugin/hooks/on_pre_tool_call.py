...
v0.9.4 philosophy: Framepack's job is done once frame.md + expanded-prompt.md
...
def register(ctx):
    ...
    logger.info("Framepack v0.9.4 pre_tool_call hook registered (handoff readiness + guardrail hydration)")
