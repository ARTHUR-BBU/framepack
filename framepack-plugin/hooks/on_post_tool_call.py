"""Framepack v0.19.0 — Prompt Factory hooks.
...
def register(ctx):
    ...
    logger.info("Framepack v0.19.0 post_tool_call hook registered (frame.md + expanded-prompt + asset-intake + guardrail hydration + lint cache bridge)")
