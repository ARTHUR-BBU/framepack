#!/usr/bin/env python
"""Framepack v0.19.0 test-team automatic acceptance script.
...
def _render_markdown(payload: dict[str, Any]) -> str:
    lines = [
        "# Framepack v0.19.0 Auto Test Report",
        "",
        f"- Repo: `{payload['repo']}`",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--output-dir", default="test-team-reports/v0.19.0", help="Directory for JSON/Markdown reports")
