#!/usr/bin/env python
"""Framepack v0.14.1 test-team automatic acceptance script.
...
FRAMEPACK_VERSION = "0.14.1"
REPORT_JSON = "framepack-v0141-auto-test-report.json"
REPORT_MD = "framepack-v0141-auto-test-report.md"
PLANNED_CHECKS = [
    "source_pytest",
...
def _render_markdown(payload: dict[str, Any]) -> str:
    lines = [
        "# Framepack v0.14.1 Auto Test Report",
        "",
        f"- Repo: `{payload['repo']}`",
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--output-dir", default="test-team-reports/v0.14.1", help="Directory for JSON/Markdown reports")
